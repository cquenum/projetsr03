            ...
            <div class="container" style="margin-left:25%;padding:1px 16px;height:1000px;">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><a href="<%= request.getContextPath()%>/suppr_competence?id=<%=competences.get(i).getId()%>">Supprimer</a></td>
                        <td><a href="<%= request.getContextPath()%>/modif_competence.jsp?id=<%=competences.get(i).getId()%>">Modifier</a></td>
                    </tr>
                        <% }%>
                </table>
            </div>
