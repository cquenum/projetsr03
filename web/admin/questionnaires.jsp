            ...
            <div class="container" style="margin-left:25%;padding:1px 16px;height:1000px;">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>Inactif</td>
                        <% }%>
                        <td><a href="<%= request.getContextPath()%>/admin/suppr_questionnaire?id=<%=questionnaires.get(i).getId()%>">Supprimer</a></td>
                        <td><a href="<%= request.getContextPath()%>/admin/modif_questionnaire.jsp?id=<%=questionnaires.get(i).getId()%>">Modifier</a></td>
                    </tr>
                        <% }%>
                </table>
            </div>
