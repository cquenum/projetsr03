            ...
            <div class="container" style="margin-left:25%;padding:1px 16px;height:1000px;">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>Inactif</td>
                        <% }%>
                        <td><a href="<%= request.getContextPath()%>/suppr_question?id=<%=questions.get(i).getId()%>">Supprimer</a></td>
                        <td><a href="<%= request.getContextPath()%>/modif_question.jsp?id=<%=questions.get(i).getId()%>">Modifier</a></td>
                    </tr>
                        <% }%>
                </table>
            </div>
