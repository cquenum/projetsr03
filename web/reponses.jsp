            ...
            <div class="container" style="margin-left:25%;padding:1px 16px;height:1000px;">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>Non</td>
                        <% }%>
                        <td><a href="<%= request.getContextPath()%>/suppr_reponse?id=<%=reponse.get(i).getId()%>">Supprimer</a></td>
                        <td><a href="<%= request.getContextPath()%>/modif_reponse.jsp?id=<%=reponse.get(i).getId()%>">Modifier</a></td>
                    </tr>
                        <% }%>
                </table>
            </div>
